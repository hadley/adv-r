...
The environment is the data structure that powers scoping. This chapter dives deep into environments, describing their structure in depth, and using them to improve your understand of the four scoping rules described in [lexical scoping](#lexical-scoping).

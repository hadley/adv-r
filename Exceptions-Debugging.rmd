...
This section discusses how to debug from the command-line. Generally these are tools of last resort and if you find you're using them very frequently you may want to reconsider your approach to writing functions: it's much easier to start simple and test as you go, than right something big and complicated and then figure out exactly where the problem is.

Three cases: function fails with an error, generates an unexpected warning, or simply gives the wrong result.

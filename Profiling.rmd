...
There is one special case of vectorisation. With matrix algebra, loops are executed by highly tuned external libraries like BLAS. So, if you can figure out a way to use matrix algebra to solve your problem, you'll often get a very fast solution. Unfortunately, the ability to recognise that your problem can be computed using a matrix algebra is a product of experience. While this is something you'll develop as you more work in you particular domain, a good place to start may be to ask for help from those with more experience.

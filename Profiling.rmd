...
Optimising code to make it run faster is an iterative process: \code{optimisation}
...
The strategy outlined below will help you avoid these pitfalls. \code{improving performance!strategy}
...
* [_Parallel R_](http://amazon.com/B005Z29QT4) by Q. Ethan McCallum and Stephen Weston.
...
* Read other R programming books, like Norm Matloff's
  [_The Art of R Programming_](http://amazon.com/1593273843) or Patrick Burns'
...
* Read general books about optimisation like 
  ...
  by Carlos Bueno, or the [_Pragmatic Programmer_](http://amazon.com/020161622X) 

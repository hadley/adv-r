...
Once you've identified a specific bottleneck to widen the pipe, rewriting it to run faster. It's difficult to provide general advice on how to do this. I make my best effort at it in [improving performance](#improve-perf) where you'll learn five techniques that can be applied to many different problems. You'll also learn a general strategy for performance optimisation that helps ensure you make your code faster without making it incorrect.

Always remember to consider the total cost of optimisation. Your time is not free: spend hours of your time to save days of computing time, don't spend minutes to save seconds.

...
Modifying an object in a loop, e.g. `x[i] <- y`, can also create a copy, depending on the class of `x`. [Modification in place](#modification-in-place) discusses this issue in more depth and gives you some tools to determine when you're making copies.

...
### Things that I know are slow

* for single x or y: `x %in% y` vs `any(x == y)`
* for s3 objects: `is()` vs `inherits()`
* using `textConnection()`
* modifying things in place
...
* http://rpubs.com/wch/13698
* https://gist.github.com/hadley/6353939
* http://rpubs.com/wch/8107

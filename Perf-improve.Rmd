...
A final technique is to rewrite in a faster language, like C++. That's a big topic and is covered in Chapter \@ref(rcpp).
...
* Section \@ref(parallelise) teaches you how to use parallelisation to
...
We'll use [profvis](https://rstudio.github.io/profvis/) to measure and visualise the performance of function calls, and [bench](https://bench.r-lib.org/) to perform experiments on small self-contained code chunks.

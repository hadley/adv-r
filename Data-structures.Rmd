...
Data frames are named lists where every element is a vector with the same length, so I'll draw them in the same way as a named list, but arranged to emphaised the columnar structure.

```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams/data-structures/data-frame.png", dpi = 300)
```

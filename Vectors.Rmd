...
<!-- 
* Section \@ref(vectors) introduces you to atomic vectors and lists, R's 1d 
  data structures.
...
* Section \@ref(matrices-and-arrays) introduces matrices and arrays,
  data structures for storing 2d and higher dimensional data.
  
* Section \@ref(data-frames) teaches you about the data frame, the most

...
A data frame is a named list of vectors with the additional constraint that every vector is the same length. This gives data frames their rectangular structure and explains why they share the properties of both matrices and lists:

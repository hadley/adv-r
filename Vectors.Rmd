...
* Wide columns are truncated to avoid a single long string occupying an entire
  ...
  right between showing as many columns possible and showing a single wide 
  column fully.)

* When used in console environments that support it, colour is used judiciously to 

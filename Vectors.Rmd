...
Data frames allow you to label each row with a "name", a character vector that does not contain any duplicates:
...
Tibbles, however, do not support row names. There are three primary reasons:

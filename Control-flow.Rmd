...
If multiple inputs have the same output, you can leave the left hand side of `=`  empty and the input will "fall through" to the next value. This mimics that behaviour of C's `switch` statement:

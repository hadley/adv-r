...
Generally speaking you shouldn't need to use `for` loops for data analysis tasks, as `map()` and `apply()` already provide flexible enough solutions to most problems. You'll learn more in Chapter \@ref(functionals).

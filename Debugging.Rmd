...
What happens when something goes wrong with your R code? What do you do? What tools do you have to address the problem? This chapter will teach you the art and science of debugging. You'll learn the tools and techniques that help you get to the root cause of an error. You'll learn general strategies for debugging, useful R functions like `traceback()` and `browser()`, and interactive tools found in RStudio.
...
(You'll learn more about functions that return functions in Section \@ref(functional-programming).)

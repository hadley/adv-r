...
Learn all about how the R language works and how you can use it to solve real problems. As well as the individual chapters link from the navbar at the top of the page, you can also [download the complete book](programming.pdf).

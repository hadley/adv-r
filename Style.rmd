...
You're reading the first edition of Advanced R; for the second edition, the style guide has been replaced by <a href = "https://style.tidyverse.org" class="alert-link">the tidyverse style guide</a>.</div>

...
One package that makes sticking to a style easy is Yihui Xie's `formatR`. It can't do everything, but if you're starting with very poorly formatted R code, it can quickly get you to a better place. Make sure to read [the notes on the wiki](https://github.com/yihui/formatR/wiki) before using it.
...
The maximum line length is 80 characters. This is the amount that will fit comfortably on the printed page with a reasonable font size. If you find you are running out of room, this is a good indication that you should encapsulate some of the work in a separate function.

...
R6 is very similar to a base OOP system called __reference classes__, or RC for short. I describe why I teach R6 here in Section \@ref(why-r6).

If you've learned OOP in another programming language, it's likely that R6 will feel natural, and you'll be inclined to prefer it over S3. Resist the temptation to follow the path of least resistance: in most cases R6 will lead you to non-idiomatic R code. 

...
Generally, however, this detail is usually not important, so elsewhere in the book I'll draw character vectors as if the individual strings live inside the vector.

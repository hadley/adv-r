...
The final place where R uses references is in character vectors. R uses a __global string pool__ and each element of a character vector is a pointer to a unique string in that pool:

...
It's easy to read this code as: "create an object named 'x', containing the values 1, 2, and 3". But that's a simplification that will lead you to make inaccurate predictions about what R is actually doing behind the scenes. It's more accurate to think about this code as doing two things:

...
Typically you shouldn't go around creating such crazy names. Instead, it's important to understand how to use `` ` `` to escape names when working with data frames that have been created outside of R, and don't follow R's rules.

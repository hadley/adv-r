...
`accumulate()` (along with the other functions in `<numeric>`, `adjacent_difference()`, `inner_product()`, and `partial_sum()`) is not that important in Rcpp because Rcpp sugar provides equivalents.

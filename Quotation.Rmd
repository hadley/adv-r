...
Instead functions that quote an argument use some other technique to allow indirect specification. Rather than unquoting, all base R approaches selectively turn quoting off, so I call them __non-quoting__ techniques.

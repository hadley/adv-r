...
Another tool similar to `invoke()` is `lang()`. It allows you to build up a call by supplying the function name (either as a string or a symbol), and arguments to the function. It's similar in intent to `expr()` and unquoting, but can 

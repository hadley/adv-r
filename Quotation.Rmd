...
* Section \@ref(case-studies) shows a few practical uses of quoting to solve
...
In other cases, in order to preserve operator precedence, R will print parentheses that do not exist in the AST:
...
Finally, R will display integer sequences as if they were generated with `:`.

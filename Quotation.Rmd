...
Every function that quotes one or more arguments and provides quasiquotation must call one of  the following three functions:
...
(There are few variants we'll learn about in the next chapter, but they follow a similar pattern.)

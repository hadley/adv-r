...
2. Write a function that opens a graphics device, runs the supplied code, and closes the graphics device (always, regardless of whether or not the plotting code worked).

3. We can use `on.exit()` to implement a simple version of `capture.output()`.
    ```{r}

...
Default arguments are evaluated inside the function. This means that if the expression depends on the current environment the results will be differ depending on whether you use the default value or explicitly provide one.

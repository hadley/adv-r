...
Because S3 is a very free system, effective use requires that you constrain yourself. 

## Basics {#s3-basics}

An S3 object is always built on a base type (typically a vector) and has the "class" attribute set. For example, take the factor. It's built on top of an integer vector, and has attributes "levels", and "class". It's the class attribute that makes this an S3 object.

...
The essence of method dispatch is quite simple, but as the chapter proceeds you'll see it gets progressively more complicated to encompass inheritance, base types, internal generics, and group generics. The code below shows a couple of more complicated cases which we'll come back to in Sections \@ref(inheritance) and \@ref(s3-dispatch). 
...
*   Scalar objects typically use a list to represent a single thing. 
    ...
    environments[^s3-pairlist]. This is generally less useful, but you can see 

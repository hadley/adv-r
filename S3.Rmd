...
An important use case of generic function is in __coercion__, which means transforming one object into another type.  If you want your class to be able to do this, you should provide a __coercion function__, which is an S3 generic called `as_class_name`.

Base R generally does not follow this convention, which can cause the kind of problems illustrated by `as.factor()`:

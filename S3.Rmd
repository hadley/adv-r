...
S3 is R's original and simplest OO system. It's the only OO system used in the base and stats packages, and it's the most commonly used system in CRAN packages. S3 is informal and ad hoc, but there's a certain elegance in its minimalism: you can't take any part of it away and still have a useful OO system. In short, unless there is a compelling reason, S3 should be your default choice for OO programming.\index{S3} \index{objects!S3|see{S3}}

S3 is a very flexible system. It will allow you to do a lot of ill-advised things. If you're coming from a strict environment like Java, this will seem pretty frightening (and it is!). It also gives your users a tremendous amount of freedom. It's very difficult to prevent them from doing something you don't want them to do. Your users will never be held back by something you haven't implemented. To use S3 safely and efficiently, you need to impose constraints yourself. Those constraints will be a focus of this chapter. 

...
Thus, the path from the top-level function, `log_analyzer()`, to
`parse_log_entry()`, which actually signals an error, is as follows:

![](restart-call-stack.png)

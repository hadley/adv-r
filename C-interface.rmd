...
The final version below moves more of the coercion logic into an accompanying R function, as does some minor restructuring to make the code a little easier to understand.

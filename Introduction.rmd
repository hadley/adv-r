...
This book has grown out of over 10 years programming in R, and my constant struggle to understand how R works. The aim of this book is to help you understand R much faster than I did (hopefully in weeks instead of years!), and become an effective R programmer as quickly as possible. Although R has its frustrating quirks, I truly believe that at its heart lies an elegant and beautiful language, well tailored for data analysis and statistics. In this book, I'll do my best to reveal that language to you, helping you to understand powerful idioms that allow you to attack many types of problems.

If you are new to R, you might wonder what makes learning such a quirky and unusual language worthwhile. To me, some of the best features of R are:

* It's free, open source and easily available on every major platform:
...
* Powerful metaprogramming facilities. R is not just a programming language,
  but is also an environment for interactive data analysis. Metaprogramming
  makes it possible to write succinct functions that are a little magical 
  in their ability to reduce the amount of typing you need. R provides an 
...
* Compared to other programming languages, the R community tends to be more
  focussed on results, not processes. There is not a lot of software 
  engineering knowledge in the community and that means that R users don't 
  know that much about testing, documentation and other good software
  development practices.

* Many package authors don't know much about software engineering either 
  so package quality varies a lot, and it's buyer beware. 
...
* Metaprogramming is a double-edged sword, and too many R functions use
  ...
  is hard to understand and will fail in unexpected ways.

* R packages are focussed on data analysis, and may be missing tools common
  in more mainstream programming languages.

Personally, I think these challenges are great opportunities for experienced programmers to have a profound positive impact on the R community. This book is my attempt at that, and I hope it will help more R users to become R programmers, and encourage programmers from other languages to contribute to R.
...
* You will be comfortable reading and understanding the majority of R code.  You'll recognise common idioms (even if you wouldn't use them yourself) and be able to critique others' code.
...
The font used for code is [inconsolata](http://levien.com/type/myfonts/inconsolata.html). 

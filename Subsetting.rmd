...
Subsetting a list works in the same way as subsetting an atomic vector. Using [` with a list `[` will always return a list: `[[` and `$`, as described below, let you pull out the components of the list.

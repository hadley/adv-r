...
2. How would you select a random sample of `m` rows from a data frame? What if the sample had to be contiguous (i.e. except for the first and last rows, every row should also have its original neighbours)? 

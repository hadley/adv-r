...
The primary use of OO programming in R is for print, summary and plot methods. These methods allow us to have one generic function, e.g. `print()`, that displays the object differently typing on its type: printing a linear model is very different to printing a data frame.

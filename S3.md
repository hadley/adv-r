...
Two basic ways to create an object in S3: with a list or with attributes.  With attributes is best if you're object behaves like a vector, list if you're starting from scratch.
...
* When implementing a vector class, you should implement these methods: `length`, `[`, `[<-`, `[[`, `[[<-`, `c`. 

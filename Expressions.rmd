...
As well as capturing names with `quote()`, it's also possible to convert strings to names. This is mostly useful when your function recieves strings as input, as it's more typing than using `quote()`:

...
*  `splat()` converts a function that takes multiple arguments to one that 
    takes a single list of arguments. \indexc{splat()} \indexc{do.call()}
...
And we now have a boolean algebra on functions, not on the results of functions. \indexc{Boolean algebra}

...
system.time(fib2(24))
```
[It is not clear to me why fib2(23) runs faster than fib(23) the first time it is called. Doesn't it need to iterate the same as fib(23) the first time it is called?]

...
Most code will be a combination of all three styles. Piping is more common in data analysis, which typically involves sequential transformations of a data frame or plot. I tend not to use piping in packages; not because it's a bad idea, but because it's often a less natural fit.

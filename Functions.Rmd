...
While you almost always create a function and then bind it to a name, the binding step it not compulsory. If you choose not to give a function a name, you get an __anonymous function__. This is useful when it's not worth the effort to figure out a name:

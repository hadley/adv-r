...
Primitive functions are only found in the base package. While they have certain performance advantages, this benefit comes at a price. They are harder to write. So R-core generally avoids creating them unless there is no other option.

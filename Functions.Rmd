...
The problem and its solution reveal why this seemingly undesirable behaviour exists: R relies on lexical scoping to find _everything_, even the `+` operator. This gives R's scoping rules a rather beautiful simplicity.

...
[^answer1]: I'll "hide" the answers to these challenges in footnotes. Try and predict the answer before you look it up; that will help you remember the correct answer better. In the case, `g1()` will return `20`.

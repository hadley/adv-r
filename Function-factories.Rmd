...
* Section \@ref(graph-fact) shows two examples of how ggplot2 works
  with user supplied function factories, and one example of where it 
...
Function factories rely on base R functionality, but we'll use a little rlang to more easily peek inside of them. We'll also use ggplot2 which has a number of components designed to work well with function factories.

...
#> 1 mean1(x)      445µs    580µs     1718.     1
#> 2 mean2(x)      210µs    247µs     3785.     0
```
...
#>   expression           min   median `itr/sec`  n_gc
#>   <chr>           <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)           4.26µs   5.12µs   188104.     0
#> 2 mean.default(x)    2.1µs   2.74µs   350653.     1
```
...
#>   expression              min   median `itr/sec`  n_gc
#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)               5.1µs   6.52µs   151892.     1
#> 2 mean.default(x)       2.4µs   3.46µs   282293.     0
#> 3 .Internal(mean(x))    583ns 753.09ns  1280701.     0
```
...
#>   expression              min   median `itr/sec`  n_gc
#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)              47.6µs   50.9µs    17816.     1
#> 2 mean.default(x)      44.2µs     46µs    19897.     0
#> 3 .Internal(mean(x))     42µs   42.4µs    21679.     0
```
...
#>   expression         min   median `itr/sec`  n_gc
#>   <chr>         <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 as.data.frame   2.35ms   2.77ms      365.     3
#> 2 quick_df       14.54µs  15.96µs    55649.     1
```
...
#>   expression        min   median `itr/sec`  n_gc
#>   <chr>        <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 lookup[x1]   898.03ns   1.17µs   841488.     0
#> 2 lookup[x10]     2.4µs    3.1µs   295102.     0
#> 3 lookup[x100]   7.62µs  11.72µs    87297.     0
```
...
#>   expression      min   median `itr/sec`  n_gc
#>   <chr>      <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 loop10      32.71µs  37.58µs    25387.     3
#> 2 loop100      1.19ms   1.26ms      755.     1
#> 3 vec10         8.5µs   9.26µs    99912.     0
#> 4 vec100      67.92µs   68.8µs    13581.     0
```

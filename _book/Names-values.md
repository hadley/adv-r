...
#> █ [1:0x2e76068] <chr> 
#> ├─[2:0x14c9498] <string: "a"> 
#> ├─[2:0x14c9498] 
#> ├─[3:0x1e84f08] <string: "abc"> 
#> └─[4:0x197b1b8] <string: "d">
```
...
#> Ncells  676587 36.2    1274918 68.1  1274918 68.1
#> Vcells 4688085 35.8   11779241 89.9 11777063 89.9
```

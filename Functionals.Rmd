...
The chances are that you've already used a functional. You might have used for-loop replacements like base R's `lapply()`, `apply()`, or `tapply()`; or maybe purrr's `map()`; or maybe you've used a mathemetical functional like `integrate()`, or `optim()`. 

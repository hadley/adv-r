...
1.  Why isn't `map(1:3, runif(2))` a useful pattern for generating random
    numbers? Can you explain why it returns the result that it does?
...
1.  The following code simulates the performance of a t-test for non-normal 
    data. How can you extract only the p-value from each test?

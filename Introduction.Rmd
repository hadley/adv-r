...
* Compared to other programming languages, the R community is more focussed on 
  results rather than processes. Knowledge of software engineering best 
...
Because the R community mostly consists of data scientists, not computer scientists there are relatively few books that go deep in the technical underpinning of R. In my personal journey to understand R, I've found it particularly helpful to use resources from other programming languages. R has aspects of both functional and object-oriented (OO) programming languages. Learning how these concepts are expressed in R will help you leverage your existing knowledge of other programming languages, and will help you identify areas where you can improve.

...
* __"[R for Data Science](http://r4ds.had.co.nz/)"__ which teaches you 
  introduces to R as tool for doing data science, focussing on a consistent
  set of packages known as the tidyverse.

* __"[R Packages](http://r-pkgs.had.co.nz/)"__ which teaches you 
  you how to make the most of R's fantastic package system.

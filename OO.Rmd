...
* S3 and S4 come from a very different heritage to the OOP found in most
...
* Investing in S4 can be helpful for building up large systems that evolve
  over many years and are written by many programmers.
  
* Mastering R6 gives you a standard way to escape R's copy-on-modify semantics
  when needed.
  
This chapter will give you a rough lay of the land, and a field guide to help you identify OOP systems in the wild. The following four chapters (Base types, S3, S4, and R6) will dive into the details, starting with R's base types. These not technically an OOP system, but they're important to understand because they're the fundamental building block of the true OOP systems.

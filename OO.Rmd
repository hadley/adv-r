...
*   In __functional__ OOP, methods belong to __generic__ functions, and method 
    ...
    function call, and internally the components are also functions [^multimethod].

[^multimethod]: A different terminology would be [multiple dispatch](https://en.wikipedia.org/wiki/Multiple_dispatch "Wikipedia Multiple Dispatch").

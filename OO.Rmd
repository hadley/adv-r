...
[^julia]: The exception is Julia, which also uses generic function OOP. Julia's implementation, however, is much more rigorous and performant than R.
...
*   In __encapsulated__ OOP, methods belong to objects or classes, and method 
    ...
    behaviour (with methods), and is paradigm found in most popular languages.

...
* There are multiple OOP systems to choose from. In this book, I'll focus 
  on the three that I believe are most important: __S3__, __S4__, and __R6__. 
  S3 and S4 are provided by base R. R6 is provided by the R6 package, and is 
  similar to the base "Reference Classes" (called __RC__ for short).
...
The goal of this brief introdutory chapter is to give you some important vocabulary and some tools to identify OOP systems in the wild. The following four chapters (Base types, S3, S4, and R6) then dive into the details of R's OOP systems. 

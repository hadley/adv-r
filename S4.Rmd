...
The diagram shows all possible methods. Usually, only a small subset of methods are defined: this is why you're using S4. I'll show which methods are defined by colouring the background of the diamond. 
...
The basic idea remains the same. You start from the class you have, and follow the arrows until you find a defined method. The wrinkle is now that there are multiple arrows to follow, so you might find multiple methods. In that case, you pick the method that is closest to target class.

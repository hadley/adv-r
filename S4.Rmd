...
<!-- GVW: should names start with '.'?  The .Person/.Employee names below suggest so. -->
...
<!-- GVW: this is the first use of "registered" - forward ref to "S4 and existing code"? -->
...
<!-- GVW: can I do new("package::class", ...)? -->
...
<!-- GVW: should I do this by default, just to be safe? -->
...
<!-- GVW: ah - so .Class is what S4 provides, and Class is what you wrap it with to validate? -->
...
<!-- GVW: why make age the same length as name? why not just insist that it's 1?  Is this to allow Person to create vectors of people? -->
...
<!-- GVW: why will this not work with classes I have defined in my own code? -->
...
<!-- GVW: I don't know enough R to parse this - does it mean I should *not* write `function(x){ standardGeneric("myGeneric")}`? -->
...
<!-- GVW: example? I don't know whether signature should take a vector of argument names or... -->
...
<!-- GVW: what if I'm trying to figure out what a valid call is? -->
...
<!-- GVW: emoji class names?  You have brought me to one of the inner circles of Hell... -->

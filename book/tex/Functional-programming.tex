...
\NormalTok{df <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{replicate}\NormalTok{(}\DecValTok{6}\NormalTok{, }\KeywordTok{sample}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, }\DecValTok{-99}\NormalTok{), }\DecValTok{6}\NormalTok{, }\DataTypeTok{rep =} \OtherTok{TRUE}\NormalTok{)))}
\KeywordTok{names}\NormalTok{(df) <-}\StringTok{ }\NormalTok{letters[}\DecValTok{1}\OperatorTok{:}\DecValTok{6}\NormalTok{]}
\NormalTok{df}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df}\OperatorTok{$}\NormalTok{c[df}\OperatorTok{$}\NormalTok{c }\OperatorTok{==}\StringTok{ }\DecValTok{-98}\NormalTok{] <-}\StringTok{ }\OtherTok{NA}
...
\NormalTok{df}\OperatorTok{$}\NormalTok{e[df}\OperatorTok{$}\NormalTok{e }\OperatorTok{==}\StringTok{ }\DecValTok{-99}\NormalTok{] <-}\StringTok{ }\OtherTok{NA}
\NormalTok{df}\OperatorTok{$}\NormalTok{f[df}\OperatorTok{$}\NormalTok{g }\OperatorTok{==}\StringTok{ }\DecValTok{-99}\NormalTok{] <-}\StringTok{ }\OtherTok{NA}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fix_missing <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
\NormalTok{  x[x }\OperatorTok{==}\StringTok{ }\DecValTok{-99}\NormalTok{] <-}\StringTok{ }\OtherTok{NA}
\NormalTok{  x}
\NormalTok{\}}
\NormalTok{df}\OperatorTok{$}\NormalTok{a <-}\StringTok{ }\KeywordTok{fix_missing}\NormalTok{(df}\OperatorTok{$}\NormalTok{a)}
\NormalTok{df}\OperatorTok{$}\NormalTok{b <-}\StringTok{ }\KeywordTok{fix_missing}\NormalTok{(df}\OperatorTok{$}\NormalTok{b)}
\NormalTok{df}\OperatorTok{$}\NormalTok{c <-}\StringTok{ }\KeywordTok{fix_missing}\NormalTok{(df}\OperatorTok{$}\NormalTok{c)}
\NormalTok{df}\OperatorTok{$}\NormalTok{d <-}\StringTok{ }\KeywordTok{fix_missing}\NormalTok{(df}\OperatorTok{$}\NormalTok{d)}
\NormalTok{df}\OperatorTok{$}\NormalTok{e <-}\StringTok{ }\KeywordTok{fix_missing}\NormalTok{(df}\OperatorTok{$}\NormalTok{e)}
\NormalTok{df}\OperatorTok{$}\NormalTok{f <-}\StringTok{ }\KeywordTok{fix_missing}\NormalTok{(df}\OperatorTok{$}\NormalTok{e)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{] <-}\StringTok{ }\KeywordTok{lapply}\NormalTok{(df[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{], fix_missing)}
\end{Highlighting}
\end{Shaded}
\end{itemize}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fix_missing_}\DecValTok{99}\NormalTok{ <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
\NormalTok{  x[x }\OperatorTok{==}\StringTok{ }\DecValTok{-99}\NormalTok{] <-}\StringTok{ }\OtherTok{NA}
\NormalTok{  x}
\NormalTok{\}}
\NormalTok{fix_missing_}\DecValTok{999}\NormalTok{ <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
\NormalTok{  x[x }\OperatorTok{==}\StringTok{ }\DecValTok{-999}\NormalTok{] <-}\StringTok{ }\OtherTok{NA}
\NormalTok{  x}
\NormalTok{\}}
\NormalTok{fix_missing_}\DecValTok{9999}\NormalTok{ <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
\NormalTok{  x[x }\OperatorTok{==}\StringTok{ }\DecValTok{-999}\NormalTok{] <-}\StringTok{ }\OtherTok{NA}
\NormalTok{  x}
\NormalTok{\}}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{missing_fixer <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(na_value) \{}
  \ControlFlowTok{function}\NormalTok{(x) \{}
\NormalTok{    x[x }\OperatorTok{==}\StringTok{ }\NormalTok{na_value] <-}\StringTok{ }\OtherTok{NA}
\NormalTok{    x}
\NormalTok{  \}}
\NormalTok{\}}
\NormalTok{fix_missing_}\DecValTok{99}\NormalTok{ <-}\StringTok{ }\KeywordTok{missing_fixer}\NormalTok{(}\OperatorTok{-}\DecValTok{99}\NormalTok{)}
\NormalTok{fix_missing_}\DecValTok{999}\NormalTok{ <-}\StringTok{ }\KeywordTok{missing_fixer}\NormalTok{(}\OperatorTok{-}\DecValTok{999}\NormalTok{)}

\KeywordTok{fix_missing_99}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{99}\NormalTok{, }\DecValTok{-999}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{fix_missing_999}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{99}\NormalTok{, }\DecValTok{-999}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fix_missing <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x, na.value) \{}
\NormalTok{  x[x }\OperatorTok{==}\StringTok{ }\NormalTok{na.value] <-}\StringTok{ }\OtherTok{NA}
\NormalTok{  x}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(df}\OperatorTok{$}\NormalTok{a)}
\KeywordTok{median}\NormalTok{(df}\OperatorTok{$}\NormalTok{a)}
\KeywordTok{sd}\NormalTok{(df}\OperatorTok{$}\NormalTok{a)}
\KeywordTok{mad}\NormalTok{(df}\OperatorTok{$}\NormalTok{a)}
\KeywordTok{IQR}\NormalTok{(df}\OperatorTok{$}\NormalTok{a)}

\KeywordTok{mean}\NormalTok{(df}\OperatorTok{$}\NormalTok{b)}
\KeywordTok{median}\NormalTok{(df}\OperatorTok{$}\NormalTok{b)}
\KeywordTok{sd}\NormalTok{(df}\OperatorTok{$}\NormalTok{b)}
\KeywordTok{mad}\NormalTok{(df}\OperatorTok{$}\NormalTok{b)}
\KeywordTok{IQR}\NormalTok{(df}\OperatorTok{$}\NormalTok{b)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{summary <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{formals}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{x =} \DecValTok{4}\NormalTok{) }\KeywordTok{g}\NormalTok{(x) }\OperatorTok{+}\StringTok{ }\KeywordTok{h}\NormalTok{(x))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{body}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{x =} \DecValTok{4}\NormalTok{) }\KeywordTok{g}\NormalTok{(x) }\OperatorTok{+}\StringTok{ }\KeywordTok{h}\NormalTok{(x))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{environment}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{x =} \DecValTok{4}\NormalTok{) }\KeywordTok{g}\NormalTok{(x) }\OperatorTok{+}\StringTok{ }\KeywordTok{h}\NormalTok{(x))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{(}\ControlFlowTok{function}\NormalTok{(x) x }\OperatorTok{+}\StringTok{ }\DecValTok{3}\NormalTok{)(}\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{f <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) x }\OperatorTok{+}\StringTok{ }\DecValTok{3}
...
\NormalTok{power <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(exponent) \{}
  ...
  \ControlFlowTok{function}\NormalTok{(x) x }\OperatorTok{^}\StringTok{ }\NormalTok{exponent}
\NormalTok{\}}
...
\NormalTok{compute_mean <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}
  ...
  \DataTypeTok{manual =} \ControlFlowTok{function}\NormalTok{(x) \{}
\NormalTok{    total <-}\StringTok{ }\DecValTok{0}
\NormalTok{    n <-}\StringTok{ }\KeywordTok{length}\NormalTok{(x)}
    \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \KeywordTok{seq_along}\NormalTok{(x)) \{}
\NormalTok{      total <-}\StringTok{ }\NormalTok{total }\OperatorTok{+}\StringTok{ }\NormalTok{x[i] }\OperatorTok{/}\StringTok{ }\NormalTok{n}
\NormalTok{    \}}
\NormalTok{    total}
\NormalTok{  \}}
\NormalTok{)}
...
\KeywordTok{system.time}\NormalTok{(compute_mean}\OperatorTok{$}\KeywordTok{base}\NormalTok{(x))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lapply}\NormalTok{(compute_mean, }\ControlFlowTok{function}\NormalTok{(f) }\KeywordTok{f}\NormalTok{(x))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lapply}\NormalTok{(compute_mean, }\ControlFlowTok{function}\NormalTok{(f) }\KeywordTok{system.time}\NormalTok{(}\KeywordTok{f}\NormalTok{(x)))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{)}
\KeywordTok{lapply}\NormalTok{(funs, }\ControlFlowTok{function}\NormalTok{(f) }\KeywordTok{f}\NormalTok{(x))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{funs2 <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}
  ...
  \DataTypeTok{median =} \ControlFlowTok{function}\NormalTok{(x, ...) }\KeywordTok{median}\NormalTok{(x, ..., }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{)}
\KeywordTok{lapply}\NormalTok{(funs2, }\ControlFlowTok{function}\NormalTok{(f) }\KeywordTok{f}\NormalTok{(x))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{simple_tag <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(tag) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{html}\OperatorTok{$}\KeywordTok{p}\NormalTok{(}\StringTok{"This is "}\NormalTok{, html}\OperatorTok{$}\KeywordTok{b}\NormalTok{(}\StringTok{"bold"}\NormalTok{), }\StringTok{" text."}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{midpoint <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(f, a, b) \{}
\NormalTok{  (b }\OperatorTok{-}\StringTok{ }\NormalTok{a) }\OperatorTok{*}\StringTok{ }\KeywordTok{f}\NormalTok{((a }\OperatorTok{+}\StringTok{ }\NormalTok{b) }\OperatorTok{/}\StringTok{ }\DecValTok{2}\NormalTok{)}
\NormalTok{\}}

\NormalTok{trapezoid <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(f, a, b) \{}
\NormalTok{  (b }\OperatorTok{-}\StringTok{ }\NormalTok{a) }\OperatorTok{/}\StringTok{ }\DecValTok{2} \OperatorTok{*}\StringTok{ }\NormalTok{(}\KeywordTok{f}\NormalTok{(a) }\OperatorTok{+}\StringTok{ }\KeywordTok{f}\NormalTok{(b))}
\NormalTok{\}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{midpoint_composite <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(f, a, b, }\DataTypeTok{n =} \DecValTok{10}\NormalTok{) \{}
\NormalTok{  points <-}\StringTok{ }\KeywordTok{seq}\NormalTok{(a, b, }\DataTypeTok{length =}\NormalTok{ n }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{)}
\NormalTok{  h <-}\StringTok{ }\NormalTok{(b }\OperatorTok{-}\StringTok{ }\NormalTok{a) }\OperatorTok{/}\StringTok{ }\NormalTok{n}

\NormalTok{  area <-}\StringTok{ }\DecValTok{0}
  \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \KeywordTok{seq_len}\NormalTok{(n)) \{}
\NormalTok{    area <-}\StringTok{ }\NormalTok{area }\OperatorTok{+}\StringTok{ }\NormalTok{h }\OperatorTok{*}\StringTok{ }\KeywordTok{f}\NormalTok{((points[i] }\OperatorTok{+}\StringTok{ }\NormalTok{points[i }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{]) }\OperatorTok{/}\StringTok{ }\DecValTok{2}\NormalTok{)}
\NormalTok{  \}}
\NormalTok{  area}
\NormalTok{\}}

\NormalTok{trapezoid_composite <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(f, a, b, }\DataTypeTok{n =} \DecValTok{10}\NormalTok{) \{}
\NormalTok{  points <-}\StringTok{ }\KeywordTok{seq}\NormalTok{(a, b, }\DataTypeTok{length =}\NormalTok{ n }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{)}
\NormalTok{  h <-}\StringTok{ }\NormalTok{(b }\OperatorTok{-}\StringTok{ }\NormalTok{a) }\OperatorTok{/}\StringTok{ }\NormalTok{n}

\NormalTok{  area <-}\StringTok{ }\DecValTok{0}
  \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \KeywordTok{seq_len}\NormalTok{(n)) \{}
\NormalTok{    area <-}\StringTok{ }\NormalTok{area }\OperatorTok{+}\StringTok{ }\NormalTok{h }\OperatorTok{/}\StringTok{ }\DecValTok{2} \OperatorTok{*}\StringTok{ }\NormalTok{(}\KeywordTok{f}\NormalTok{(points[i]) }\OperatorTok{+}\StringTok{ }\KeywordTok{f}\NormalTok{(points[i }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{]))}
\NormalTok{  \}}
\NormalTok{  area}
\NormalTok{\}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{composite <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(f, a, b, }\DataTypeTok{n =} \DecValTok{10}\NormalTok{, rule) \{}
\NormalTok{  points <-}\StringTok{ }\KeywordTok{seq}\NormalTok{(a, b, }\DataTypeTok{length =}\NormalTok{ n }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{)}

\NormalTok{  area <-}\StringTok{ }\DecValTok{0}
  \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \KeywordTok{seq_len}\NormalTok{(n)) \{}
\NormalTok{    area <-}\StringTok{ }\NormalTok{area }\OperatorTok{+}\StringTok{ }\KeywordTok{rule}\NormalTok{(f, points[i], points[i }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{])}
\NormalTok{  \}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{simpson <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(f, a, b) \{}
\NormalTok{  (b }\OperatorTok{-}\StringTok{ }\NormalTok{a) }\OperatorTok{/}\StringTok{ }\DecValTok{6} \OperatorTok{*}\StringTok{ }\NormalTok{(}\KeywordTok{f}\NormalTok{(a) }\OperatorTok{+}\StringTok{ }\DecValTok{4} \OperatorTok{*}\StringTok{ }\KeywordTok{f}\NormalTok{((a }\OperatorTok{+}\StringTok{ }\NormalTok{b) }\OperatorTok{/}\StringTok{ }\DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{f}\NormalTok{(b))}
\NormalTok{\}}

\NormalTok{boole <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(f, a, b) \{}
\NormalTok{  pos <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(i) a }\OperatorTok{+}\StringTok{ }\NormalTok{i }\OperatorTok{*}\StringTok{ }\NormalTok{(b }\OperatorTok{-}\StringTok{ }\NormalTok{a) }\OperatorTok{/}\StringTok{ }\DecValTok{4}
\NormalTok{  fi <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(i) }\KeywordTok{f}\NormalTok{(}\KeywordTok{pos}\NormalTok{(i))}

\NormalTok{  (b }\OperatorTok{-}\StringTok{ }\NormalTok{a) }\OperatorTok{/}\StringTok{ }\DecValTok{90} \OperatorTok{*}
\StringTok{    }\NormalTok{(}\DecValTok{7} \OperatorTok{*}\StringTok{ }\KeywordTok{fi}\NormalTok{(}\DecValTok{0}\NormalTok{) }\OperatorTok{+}\StringTok{ }\DecValTok{32} \OperatorTok{*}\StringTok{ }\KeywordTok{fi}\NormalTok{(}\DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }\DecValTok{12} \OperatorTok{*}\StringTok{ }\KeywordTok{fi}\NormalTok{(}\DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }\DecValTok{32} \OperatorTok{*}\StringTok{ }\KeywordTok{fi}\NormalTok{(}\DecValTok{3}\NormalTok{) }\OperatorTok{+}\StringTok{ }\DecValTok{7} \OperatorTok{*}\StringTok{ }\KeywordTok{fi}\NormalTok{(}\DecValTok{4}\NormalTok{))}
\NormalTok{\}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{newton_cotes <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(coef, }\DataTypeTok{open =} \OtherTok{FALSE}\NormalTok{) \{}
\NormalTok{  n <-}\StringTok{ }\KeywordTok{length}\NormalTok{(coef) }\OperatorTok{+}\StringTok{ }\NormalTok{open}

  \ControlFlowTok{function}\NormalTok{(f, a, b) \{}
\NormalTok{    pos <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(i) a }\OperatorTok{+}\StringTok{ }\NormalTok{i }\OperatorTok{*}\StringTok{ }\NormalTok{(b }\OperatorTok{-}\StringTok{ }\NormalTok{a) }\OperatorTok{/}\StringTok{ }\NormalTok{n}
\NormalTok{    points <-}\StringTok{ }\KeywordTok{pos}\NormalTok{(}\KeywordTok{seq.int}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{length}\NormalTok{(coef) }\OperatorTok{-}\StringTok{ }\DecValTok{1}\NormalTok{))}

\NormalTok{    (b }\OperatorTok{-}\StringTok{ }\NormalTok{a) }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(coef) }\OperatorTok{*}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\KeywordTok{f}\NormalTok{(points) }\OperatorTok{*}\StringTok{ }\NormalTok{coef)}
\NormalTok{  \}}
\NormalTok{\}}

...
\OperatorTok{%in%}\NormalTok{, match}
\NormalTok{=, <-, <<-}
...
\OperatorTok{!=}\NormalTok{, }\OperatorTok{==}\NormalTok{, }\OperatorTok{>}\NormalTok{, }\OperatorTok{>=}\NormalTok{, }\OperatorTok{<}\NormalTok{, }\OperatorTok{<=}
\NormalTok{is.na, complete.cases}
\NormalTok{is.finite}

\CommentTok{# Basic math}
\OperatorTok{*}\NormalTok{, }\OperatorTok{+}\NormalTok{, }\OperatorTok{-}\NormalTok{, }\OperatorTok{/}\NormalTok{, }\OperatorTok{^}\NormalTok{, }\OperatorTok{%%}\NormalTok{, }\OperatorTok{%/%}
\NormalTok{abs, sign}
...
\OperatorTok{&}\NormalTok{, }\OperatorTok{|}\NormalTok{, }\OperatorTok{!}\NormalTok{, xor}
\NormalTok{all, any}
...
\NormalTok{(is}\OperatorTok{/}\NormalTok{as).(character}\OperatorTok{/}\NormalTok{numeric}\OperatorTok{/}\NormalTok{logical}\OperatorTok{/}\NormalTok{...)}
...
\ControlFlowTok{if}\NormalTok{, }\OperatorTok{&&}\NormalTok{, }\OperatorTok{||}\StringTok{ }\NormalTok{(short circuiting)}
\ControlFlowTok{for}\NormalTok{, }\ControlFlowTok{while}
\ControlFlowTok{next}\NormalTok{, }\ControlFlowTok{break}
\ControlFlowTok{switch}
\NormalTok{ifelse}
...
\hypertarget{common-data-structures}{%
...
\NormalTok{formula, }\OperatorTok{~}\NormalTok{, I}
...
\NormalTok{(q, p, d, r) }\OperatorTok{*}\StringTok{ }\NormalTok{(beta, binom, cauchy, chisq, exp, f, gamma, geom, }
...
\OperatorTok{%*%}\NormalTok{, }\OperatorTok{%o%}\NormalTok{, outer}
\NormalTok{rcond}
\NormalTok{solve}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{dir}
\NormalTok{basename, dirname, tools}\OperatorTok{::}\NormalTok{file_ext}
\NormalTok{file.path}

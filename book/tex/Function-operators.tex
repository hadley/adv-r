...
\CommentTok{#> [1] 0.5916 0.2663 0.9651 0.4808 0.4759}
\KeywordTok{runifm}\NormalTok{(}\DecValTok{5}\NormalTok{)}
\CommentTok{#> [1] 0.5916 0.2663 0.9651 0.4808 0.4759}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> [1] 0.01581 0.33986 0.55830 0.45425 0.05724}
...
\CommentTok{#> List of 3}
\CommentTok{#>  $ : int [1:5] 4 3 5 2 1}
\CommentTok{#>  $ : int [1:4] 5 4 2 1}
\CommentTok{#>  $ : int [1:3] 1 4 2}
\end{Highlighting}
\end{Shaded}

...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{structure}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, }\DataTypeTok{my_attribute =} \StringTok{"This is a vector"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
defines the set of allowed values. \index{factors|(}
...
\KeywordTok{typeof}\NormalTok{(z}\OperatorTok{$}\NormalTok{value)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{as.double}\NormalTok{(z}\OperatorTok{$}\NormalTok{value)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{class}\NormalTok{(z}\OperatorTok{$}\NormalTok{value)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{as.double}\NormalTok{(}\KeywordTok{as.character}\NormalTok{(z}\OperatorTok{$}\NormalTok{value))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{z}\OperatorTok{$}\NormalTok{value}
\end{Highlighting}
\end{Shaded}
...
much rarer, but worth being aware of. \index{arrays|(}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dfm <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{x =} \DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{, }\DataTypeTok{y =} \KeywordTok{I}\NormalTok{(}\KeywordTok{matrix}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{9}\NormalTok{, }\DataTypeTok{nrow =} \DecValTok{3}\NormalTok{)))}

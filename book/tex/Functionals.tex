...
\CommentTok{#>  [1]  7  6  8  5  2  8 10  9  6  7  7  2  3 10 10  4  1  4  5}
\CommentTok{#> [20]  9}
...
\CommentTok{#> [1] -1.59587  0.06002  0.03764  0.04927}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> [1] 0.6004 0.4792 0.4586 0.4762 0.4570}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\}))}
\CommentTok{#> [1] 0.6673 0.5103 0.5303 0.5266 0.4285}
\end{Highlighting}
\end{Shaded}

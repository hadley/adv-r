...
\CommentTok{#>  [1]  8  8  1  4  6  6  9  8  9 10  2  6  4  3  2  7  3 10  6}
\CommentTok{#> [20]  9}
...
\CommentTok{#> [1]  1.48503 -0.07759 -0.04445 -0.03894}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> [1] 0.4696 0.4793 0.4474 0.5755 0.4490}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\}))}
\CommentTok{#> [1] 0.4554 0.5370 0.4301 0.6391 0.4411}
\end{Highlighting}
\end{Shaded}
...
\begin{shortbox}\begin{minipage}{25pc}\Boxhead{mapply}
...
\CommentTok{#> $A}
\CommentTok{#>  [1] 74 75 73 74 72 63 74 75 71 65}
\CommentTok{#> }
\CommentTok{#> $B}
\CommentTok{#>  [1] 72 72 73 77 73 78 68 78 75 77 71 80}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>  $ : int [1:15] 4 10 7 9 3 10 8 7 2 2 ...}
\CommentTok{#>  $ : int [1:15] 10 3 10 2 2 6 9 6 4 4 ...}
\CommentTok{#>  $ : int [1:15] 1 5 9 9 1 8 5 7 5 7 ...}
\CommentTok{#>  $ : int [1:15] 6 2 10 5 6 3 1 6 1 2 ...}
\CommentTok{#>  $ : int [1:15] 10 5 10 7 7 1 9 9 9 7 ...}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> [1] 0.3607 0.3607 0.2030 0.1066 0.1931 0.2594 0.4287}
\end{Highlighting}
\end{Shaded}

...
\CommentTok{#> <environment: 0x7ff93aee1590>}
...
\CommentTok{#> [1] FALSE}
\end{Highlighting}
\end{Shaded}\enlargethispage{12pt}
...
\CommentTok{#> Error in globalenv() == environment(): comparison (1) is possible} 
\CommentTok{only for atomic and list types}
\end{Highlighting}
\end{Shaded}

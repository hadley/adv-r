...
create programs with other programs! \index{metaprogramming}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{z <-}\StringTok{ }\KeywordTok{quote}\NormalTok{(y <-}\StringTok{ }\NormalTok{x }\OperatorTok{*}\StringTok{ }\DecValTok{10}\NormalTok{)}
\NormalTok{z}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ast}\NormalTok{(y <-}\StringTok{ }\NormalTok{x }\OperatorTok{*}\StringTok{ }\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ast}\NormalTok{(a }\OperatorTok{+}\StringTok{ }\NormalTok{b)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ast}\NormalTok{(}\ControlFlowTok{if}\NormalTok{ (x }\OperatorTok{>}\StringTok{ }\DecValTok{1}\NormalTok{) x }\ControlFlowTok{else} \DecValTok{1}\OperatorTok{/}\NormalTok{x)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ast}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{x =} \DecValTok{1}\NormalTok{, y) x)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ast}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{x =} \DecValTok{1}\NormalTok{, }\DataTypeTok{y =}\NormalTok{ x }\OperatorTok{*}\StringTok{ }\DecValTok{2}\NormalTok{) \{x }\OperatorTok{/}\StringTok{ }\NormalTok{y\})}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str}\NormalTok{(}\KeywordTok{quote}\NormalTok{(a }\OperatorTok{+}\StringTok{ }\NormalTok{b))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{f <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) }\DecValTok{10}
\KeywordTok{formals}\NormalTok{(f)}\OperatorTok{$}\NormalTok{x}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{is.name}\NormalTok{(}\KeywordTok{formals}\NormalTok{(f)}\OperatorTok{$}\NormalTok{x)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{as.character}\NormalTok{(}\KeywordTok{formals}\NormalTok{(f)}\OperatorTok{$}\NormalTok{x)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{missing_arg <-}\StringTok{ }\KeywordTok{formals}\NormalTok{(f)}\OperatorTok{$}\NormalTok{x}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{g <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{x =} \DecValTok{20}\NormalTok{, y) \{}
...
\NormalTok{y}\OperatorTok{$}\NormalTok{row.names <-}\StringTok{ }\OtherTok{TRUE}
\NormalTok{y}\OperatorTok{$}\NormalTok{col.names <-}\StringTok{ }\OtherTok{FALSE}
\NormalTok{y}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{y}\OperatorTok{$}\NormalTok{sep <-}\StringTok{ ","}
\NormalTok{y}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x[}\OperatorTok{-}\DecValTok{3}\NormalTok{] }\CommentTok{# remove the second argument}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x[}\OperatorTok{-}\DecValTok{1}\NormalTok{] }\CommentTok{# remove the function name - but it's still a call!}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{call}\NormalTok{(}\StringTok{"mean"}\NormalTok{, }\KeywordTok{quote}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{), }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{as.call}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\KeywordTok{quote}\NormalTok{(mean), }\KeywordTok{quote}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(a <-}\StringTok{ }\KeywordTok{call}\NormalTok{(}\StringTok{"mean"}\NormalTok{, }\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(b <-}\StringTok{ }\KeywordTok{call}\NormalTok{(}\StringTok{"mean"}\NormalTok{, }\KeywordTok{quote}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{standardise_call}\NormalTok{(}\KeywordTok{quote}\NormalTok{(}\KeywordTok{mean}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{standardise_call}\NormalTok{(}\KeywordTok{quote}\NormalTok{(}\KeywordTok{mean}\NormalTok{(}\DataTypeTok{n =}\NormalTok{ T, }\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{standardise_call}\NormalTok{(}\KeywordTok{quote}\NormalTok{(}\KeywordTok{mean}\NormalTok{(}\DataTypeTok{x =} \DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, , }\OtherTok{TRUE}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{f <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{abc =} \DecValTok{1}\NormalTok{, }\DataTypeTok{def =} \DecValTok{2}\NormalTok{, }\DataTypeTok{ghi =} \DecValTok{3}\NormalTok{) \{}
...
\KeywordTok{update}\NormalTok{(mod, }\DataTypeTok{formula =}\NormalTok{ . }\OperatorTok{~}\StringTok{ }\NormalTok{. }\OperatorTok{+}\StringTok{ }\NormalTok{cyl)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{update_call <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{ (object, formula., ...) \{}
\NormalTok{  call <-}\StringTok{ }\NormalTok{object}\OperatorTok{$}\NormalTok{call}

  \CommentTok{# Use update.formula to deal with formulas like . ~ .}
  \ControlFlowTok{if}\NormalTok{ (}\OperatorTok{!}\KeywordTok{missing}\NormalTok{(formula.)) \{}
\NormalTok{    call}\OperatorTok{$}\NormalTok{formula <-}\StringTok{ }\KeywordTok{update.formula}\NormalTok{(}\KeywordTok{formula}\NormalTok{(object), formula.)}
\NormalTok{  \}}

  \KeywordTok{modify_call}\NormalTok{(call, }\KeywordTok{dots}\NormalTok{(...))}
\NormalTok{\}}
\NormalTok{update_model <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(object, formula., ...) \{}
...
\NormalTok{\}}
\KeywordTok{update_model}\NormalTok{(mod, }\DataTypeTok{formula =}\NormalTok{ . }\OperatorTok{~}\StringTok{ }\NormalTok{. }\OperatorTok{+}\StringTok{ }\NormalTok{cyl)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  n <-}\StringTok{ }\DecValTok{3}
  \KeywordTok{lm}\NormalTok{(mpg }\OperatorTok{~}\StringTok{ }\KeywordTok{poly}\NormalTok{(wt, n), }\DataTypeTok{data =}\NormalTok{ mtcars)}
\NormalTok{\}}
...
topic is explored in more detail in \protect\hyperlink{gc}{garbage
collection}. \index{environments|capturing}
...
\NormalTok{  Call <-}\StringTok{ }\KeywordTok{match.call}\NormalTok{(}\DataTypeTok{expand.dots =} \OtherTok{TRUE}\NormalTok{)}
  \ControlFlowTok{for}\NormalTok{ (arg }\ControlFlowTok{in} \KeywordTok{c}\NormalTok{(}\StringTok{"append"}\NormalTok{, }\StringTok{"col.names"}\NormalTok{, }\StringTok{"sep"}\NormalTok{, }\StringTok{"dec"}\NormalTok{, }\StringTok{"qmethod"}\NormalTok{)) \{}
    \ControlFlowTok{if}\NormalTok{ (}\OperatorTok{!}\KeywordTok{is.null}\NormalTok{(Call[[arg]])) \{}
      \KeywordTok{warning}\NormalTok{(}\KeywordTok{gettextf}\NormalTok{(}\StringTok{"attempt to set '%s' ignored"}\NormalTok{, arg))}
\NormalTok{    \}}
\NormalTok{  \}}
\NormalTok{  rn <-}\StringTok{ }\KeywordTok{eval.parent}\NormalTok{(Call}\OperatorTok{$}\NormalTok{row.names)}
\NormalTok{  Call}\OperatorTok{$}\NormalTok{append <-}\StringTok{ }\OtherTok{NULL}
\NormalTok{  Call}\OperatorTok{$}\NormalTok{col.names <-}\StringTok{ }\ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.logical}\NormalTok{(rn) }\OperatorTok{&&}\StringTok{ }\OperatorTok{!}\NormalTok{rn) }\OtherTok{TRUE} \ControlFlowTok{else} \OtherTok{NA}
\NormalTok{  Call}\OperatorTok{$}\NormalTok{sep <-}\StringTok{ ","}
\NormalTok{  Call}\OperatorTok{$}\NormalTok{dec <-}\StringTok{ "."}
\NormalTok{  Call}\OperatorTok{$}\NormalTok{qmethod <-}\StringTok{ "double"}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{write.csv <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x, }\DataTypeTok{file =} \StringTok{""}\NormalTok{, }\DataTypeTok{sep =} \StringTok{","}\NormalTok{, }\DataTypeTok{qmethod =} \StringTok{"double"}\NormalTok{, }
\NormalTok{                      ...) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{make_function <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(args, body, }\DataTypeTok{env =} \KeywordTok{parent.frame}\NormalTok{()) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{add <-}\StringTok{ }\KeywordTok{make_function}\NormalTok{(}\KeywordTok{alist}\NormalTok{(}\DataTypeTok{a =} \DecValTok{1}\NormalTok{, }\DataTypeTok{b =} \DecValTok{2}\NormalTok{), }\KeywordTok{quote}\NormalTok{(a }\OperatorTok{+}\StringTok{ }\NormalTok{b))}
...
\KeywordTok{make_function}\NormalTok{(}\KeywordTok{alist}\NormalTok{(}\DataTypeTok{a =}\NormalTok{ , }\DataTypeTok{b =}\NormalTok{ a), }\KeywordTok{quote}\NormalTok{(a }\OperatorTok{+}\StringTok{ }\NormalTok{b))}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{make_function}\NormalTok{(}\KeywordTok{alist}\NormalTok{(}\DataTypeTok{a =}\NormalTok{ , }\DataTypeTok{b =}\NormalTok{ , }\DataTypeTok{... =}\NormalTok{), }\KeywordTok{quote}\NormalTok{(a }\OperatorTok{+}\StringTok{ }\NormalTok{b))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{adder <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
  \KeywordTok{make_function}\NormalTok{(}\KeywordTok{alist}\NormalTok{(}\DataTypeTok{y =}\NormalTok{), }\KeywordTok{substitute}\NormalTok{(\{x }\OperatorTok{+}\StringTok{ }\NormalTok{y\}), }\KeywordTok{parent.frame}\NormalTok{())}
\NormalTok{\}}
...
\includegraphics{/home/elio/Documents/adv-r/book/tex/Expressions_files/figure-latex/curve-demo-1.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{curve3 <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(expr, }\DataTypeTok{xlim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{), }\DataTypeTok{n =} \DecValTok{100}\NormalTok{,}
                   \DataTypeTok{env =} \KeywordTok{parent.frame}\NormalTok{()) \{}
\NormalTok{  env2 <-}\StringTok{ }\KeywordTok{new.env}\NormalTok{(}\DataTypeTok{parent =}\NormalTok{ env)}
\NormalTok{  env2}\OperatorTok{$}\NormalTok{x <-}\StringTok{ }\KeywordTok{seq}\NormalTok{(xlim[}\DecValTok{1}\NormalTok{], xlim[}\DecValTok{2}\NormalTok{], }\DataTypeTok{length =}\NormalTok{ n)}

\NormalTok{  y <-}\StringTok{ }\KeywordTok{eval}\NormalTok{(}\KeywordTok{substitute}\NormalTok{(expr), env2)}
  \KeywordTok{plot}\NormalTok{(env2}\OperatorTok{$}\NormalTok{x, y, }\DataTypeTok{type =} \StringTok{"l"}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{simple_source <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(file, }\DataTypeTok{envir =} \KeywordTok{new.env}\NormalTok{()) \{}
...
\NormalTok{  n <-}\StringTok{ }\KeywordTok{length}\NormalTok{(exprs)}
  \ControlFlowTok{if}\NormalTok{ (n }\OperatorTok{==}\StringTok{ }\NormalTok{0L) }\KeywordTok{return}\NormalTok{(}\KeywordTok{invisible}\NormalTok{())}
...
\NormalTok{recurse_call <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.atomic}\NormalTok{(x)) \{}
    \CommentTok{# Return a value}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.name}\NormalTok{(x)) \{}
    \CommentTok{# Return a value}
...
\NormalTok{logical_abbr <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.atomic}\NormalTok{(x)) \{}
    \OtherTok{FALSE}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.name}\NormalTok{(x)) \{}
    \KeywordTok{identical}\NormalTok{(x, }\KeywordTok{quote}\NormalTok{(T)) }\OperatorTok{||}\StringTok{ }\KeywordTok{identical}\NormalTok{(x, }\KeywordTok{quote}\NormalTok{(F))}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.call}\NormalTok{(x) }\OperatorTok{||}\StringTok{ }\KeywordTok{is.pairlist}\NormalTok{(x)) \{}
    \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \KeywordTok{seq_along}\NormalTok{(x)) \{}
      \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{logical_abbr}\NormalTok{(x[[i]])) }\KeywordTok{return}\NormalTok{(}\OtherTok{TRUE}\NormalTok{)}
\NormalTok{    \}}
    \OtherTok{FALSE}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
    \KeywordTok{stop}\NormalTok{(}\StringTok{"Don't know how to handle type "}\NormalTok{, }\KeywordTok{typeof}\NormalTok{(x), }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{logical_abbr}\NormalTok{(}\KeywordTok{quote}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(x, }\DataTypeTok{na.rm =}\NormalTok{ T) }\OtherTok{FALSE}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{find_assign <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.atomic}\NormalTok{(x) }\OperatorTok{||}\StringTok{ }\KeywordTok{is.name}\NormalTok{(x)) \{}
    \OtherTok{NULL}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.call}\NormalTok{(x)) \{}
    \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{identical}\NormalTok{(x[[}\DecValTok{1}\NormalTok{]], }\KeywordTok{quote}\NormalTok{(}\StringTok{`}\DataTypeTok{<-}\StringTok{`}\NormalTok{))) \{}
\NormalTok{      x[[}\DecValTok{2}\NormalTok{]]}
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{ \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{find_assign2 <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.atomic}\NormalTok{(x) }\OperatorTok{||}\StringTok{ }\KeywordTok{is.name}\NormalTok{(x)) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{find_assign3 <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.atomic}\NormalTok{(x) }\OperatorTok{||}\StringTok{ }\KeywordTok{is.name}\NormalTok{(x)) \{}
    \KeywordTok{character}\NormalTok{()}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.call}\NormalTok{(x)) \{}
    \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{identical}\NormalTok{(x[[}\DecValTok{1}\NormalTok{]], }\KeywordTok{quote}\NormalTok{(}\StringTok{`}\DataTypeTok{<-}\StringTok{`}\NormalTok{))) \{}
...
\NormalTok{  l}\OperatorTok{$}\NormalTok{a <-}\StringTok{ }\DecValTok{5}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ast}\NormalTok{(l}\OperatorTok{$}\NormalTok{a <-}\StringTok{ }\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{find_assign4 <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.atomic}\NormalTok{(x) }\OperatorTok{||}\StringTok{ }\KeywordTok{is.name}\NormalTok{(x)) \{}
    \KeywordTok{character}\NormalTok{()}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.call}\NormalTok{(x)) \{}
    \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{identical}\NormalTok{(x[[}\DecValTok{1}\NormalTok{]], }\KeywordTok{quote}\NormalTok{(}\StringTok{`}\DataTypeTok{<-}\StringTok{`}\NormalTok{)) }\OperatorTok{&&}\StringTok{ }\KeywordTok{is.name}\NormalTok{(x[[}\DecValTok{2}\NormalTok{]])) \{}
\NormalTok{      lhs <-}\StringTok{ }\KeywordTok{as.character}\NormalTok{(x[[}\DecValTok{2}\NormalTok{]])}
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{      lhs <-}\StringTok{ }\KeywordTok{character}\NormalTok{()}
\NormalTok{    \}}
...
\KeywordTok{bquote}\NormalTok{(a }\OperatorTok{+}\StringTok{ }\NormalTok{b)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bquote2 <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{ (x, }\DataTypeTok{where =} \KeywordTok{parent.frame}\NormalTok{()) \{}
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.atomic}\NormalTok{(x) }\OperatorTok{||}\StringTok{ }\KeywordTok{is.name}\NormalTok{(x)) \{}
    \CommentTok{# Leave unchanged}
\NormalTok{    x}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.call}\NormalTok{(x)) \{}
    \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{identical}\NormalTok{(x[[}\DecValTok{1}\NormalTok{]], }\KeywordTok{quote}\NormalTok{(.))) \{}
...
\KeywordTok{bquote2}\NormalTok{(}\KeywordTok{quote}\NormalTok{(x }\OperatorTok{==}\StringTok{ }\NormalTok{.(x)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{bquote2}\NormalTok{(}\KeywordTok{quote}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ .(x)) \{}
\NormalTok{  x }\OperatorTok{+}\StringTok{ }\NormalTok{.(y)}
\NormalTok{\}))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  x }\OperatorTok{+}\StringTok{  }\CommentTok{# funky spacing}

...
\CommentTok{#> [[1]]}
\CommentTok{#> [1] 6.941e-310 6.941e-310 6.941e-310  0.000e+00}
\CommentTok{#> }
\CommentTok{#> [[2]]}
\CommentTok{#> [1] TRUE TRUE TRUE TRUE}
\CommentTok{#> }
\CommentTok{#> [[3]]}
\CommentTok{#> [1]     2     4     8 32710}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>  add_one(x) 4.950 5.093  6.199 7.571 41.81   100}
\CommentTok{#>  add_two(x) 1.106 1.220  2.309 3.673 34.88   100}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> \}}
\CommentTok{#> <bytecode: 0x7fc69d9930b0>}

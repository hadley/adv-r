...
\CommentTok{#> [[1]]}
\CommentTok{#> [1]        NaN 2.154e-314 2.122e-314 2.154e-314}
\CommentTok{#> }
\CommentTok{#> [[2]]}
\CommentTok{#> [1] TRUE TRUE TRUE TRUE}
\CommentTok{#> }
\CommentTok{#> [[3]]}
\CommentTok{#> [1]  1404802533 -1067575430  -847901940  1332270628}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>  add_one(x) 5.014 5.524  5.881 7.166 35.14   100}
\CommentTok{#>  add_two(x) 1.242 1.394  2.124 3.366 29.65   100}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> \}}
\CommentTok{#> <bytecode: 0x7fe064e78638>}

...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{translate_sql}\NormalTok{(}\KeywordTok{sin}\NormalTok{(x) }\OperatorTok{+}\StringTok{ }\KeywordTok{tan}\NormalTok{(y))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{translate_sql}\NormalTok{(x }\OperatorTok{<}\StringTok{ }\DecValTok{5} \OperatorTok{&}\StringTok{ }\OperatorTok{!}\NormalTok{(y }\OperatorTok{>=}\StringTok{ }\DecValTok{5}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{translate_sql}\NormalTok{(first }\OperatorTok{%like%}\StringTok{ "Had*"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{translate_sql}\NormalTok{(first }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"John"}\NormalTok{, }\StringTok{"Roger"}\NormalTok{, }\StringTok{"Robert"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{translate_sql}\NormalTok{(like }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{html <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{structure}\NormalTok{(x, }\DataTypeTok{class =} \StringTok{"html"}\NormalTok{)}
\NormalTok{print.html <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x, ...) \{}
...
\NormalTok{escape.html <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) x}
...
\NormalTok{\}}
\NormalTok{escape.list <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{named <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.null}\NormalTok{(}\KeywordTok{names}\NormalTok{(x))) }\KeywordTok{return}\NormalTok{(}\OtherTok{NULL}\NormalTok{)}
\NormalTok{  x[}\KeywordTok{names}\NormalTok{(x) }\OperatorTok{!=}\StringTok{ ""}\NormalTok{]}
\NormalTok{\}}
\NormalTok{unnamed <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
  \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.null}\NormalTok{(}\KeywordTok{names}\NormalTok{(x))) }\KeywordTok{return}\NormalTok{(x)}
\NormalTok{  x[}\KeywordTok{names}\NormalTok{(x) }\OperatorTok{==}\StringTok{ ""}\NormalTok{]}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{void_tag <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(tag) \{}
  ...
  \ControlFlowTok{function}\NormalTok{(...) \{}
\NormalTok{    args <-}\StringTok{ }\KeywordTok{list}\NormalTok{(...)}
    \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{length}\NormalTok{(}\KeywordTok{unnamed}\NormalTok{(args)) }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tag_fs}\OperatorTok{$}\KeywordTok{p}\NormalTok{(}\StringTok{"Some text."}\NormalTok{, tag_fs}\OperatorTok{$}\KeywordTok{b}\NormalTok{(}\StringTok{"Some bold text"}\NormalTok{),}
\NormalTok{  tag_fs}\OperatorTok{$}\KeywordTok{i}\NormalTok{(}\StringTok{"Some italic text"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    children <-}\StringTok{ }\KeywordTok{lapply}\NormalTok{(x[}\OperatorTok{-}\DecValTok{1}\NormalTok{], all_names)}
...
\KeywordTok{all_names}\NormalTok{(}\KeywordTok{quote}\NormalTok{(x }\OperatorTok{+}\StringTok{ }\NormalTok{y }\OperatorTok{+}\StringTok{ }\KeywordTok{f}\NormalTok{(a, b, c, }\DecValTok{10}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{clone_env <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(env, }\DataTypeTok{parent =} \KeywordTok{parent.env}\NormalTok{(env)) \{}
...
\NormalTok{unary_op <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(left, right) \{}
  ...
  \ControlFlowTok{function}\NormalTok{(e1) \{}
...
\NormalTok{f_env}\OperatorTok{$}\StringTok{"+"}\NormalTok{ <-}\StringTok{ }\KeywordTok{binary_op}\NormalTok{(}\StringTok{" + "}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\StringTok{"-"}\NormalTok{ <-}\StringTok{ }\KeywordTok{binary_op}\NormalTok{(}\StringTok{" - "}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\StringTok{"*"}\NormalTok{ <-}\StringTok{ }\KeywordTok{binary_op}\NormalTok{(}\StringTok{" * "}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\StringTok{"/"}\NormalTok{ <-}\StringTok{ }\KeywordTok{binary_op}\NormalTok{(}\StringTok{" / "}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\StringTok{"^"}\NormalTok{ <-}\StringTok{ }\KeywordTok{binary_op}\NormalTok{(}\StringTok{"^"}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\StringTok{"["}\NormalTok{ <-}\StringTok{ }\KeywordTok{binary_op}\NormalTok{(}\StringTok{"_"}\NormalTok{)}

\CommentTok{# Grouping}
\NormalTok{f_env}\OperatorTok{$}\StringTok{"\{"}\NormalTok{ <-}\StringTok{ }\KeywordTok{unary_op}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{left\{ "}\NormalTok{, }\StringTok{" }\CharTok{\textbackslash{}\textbackslash{}}\StringTok{right\}"}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\StringTok{"("}\NormalTok{ <-}\StringTok{ }\KeywordTok{unary_op}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{left( "}\NormalTok{, }\StringTok{" }\CharTok{\textbackslash{}\textbackslash{}}\StringTok{right)"}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\NormalTok{paste <-}\StringTok{ }\NormalTok{paste}

\CommentTok{# Other math functions}
\NormalTok{f_env}\OperatorTok{$}\NormalTok{sqrt <-}\StringTok{ }\KeywordTok{unary_op}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{sqrt\{"}\NormalTok{, }\StringTok{"\}"}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\NormalTok{sin <-}\StringTok{ }\KeywordTok{unary_op}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{sin("}\NormalTok{, }\StringTok{")"}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\NormalTok{log <-}\StringTok{ }\KeywordTok{unary_op}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{log("}\NormalTok{, }\StringTok{")"}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\NormalTok{abs <-}\StringTok{ }\KeywordTok{unary_op}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{left| "}\NormalTok{, }\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{right| "}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\NormalTok{frac <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(a, b) \{}
...
\NormalTok{f_env}\OperatorTok{$}\NormalTok{hat <-}\StringTok{ }\KeywordTok{unary_op}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{hat\{"}\NormalTok{, }\StringTok{"\}"}\NormalTok{)}
\NormalTok{f_env}\OperatorTok{$}\NormalTok{tilde <-}\StringTok{ }\KeywordTok{unary_op}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{tilde\{"}\NormalTok{, }\StringTok{"\}"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    children <-}\StringTok{ }\KeywordTok{lapply}\NormalTok{(x[}\OperatorTok{-}\DecValTok{1}\NormalTok{], all_calls)}
...
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{is.pairlist}\NormalTok{(x)) \{}
    \KeywordTok{unique}\NormalTok{(}\KeywordTok{unlist}\NormalTok{(}\KeywordTok{lapply}\NormalTok{(x[}\OperatorTok{-}\DecValTok{1}\NormalTok{], all_calls), }\DataTypeTok{use.names =} \OtherTok{FALSE}\NormalTok{))}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
...
\KeywordTok{all_calls}\NormalTok{(}\KeywordTok{quote}\NormalTok{(}\KeywordTok{f}\NormalTok{(g }\OperatorTok{+}\StringTok{ }\NormalTok{b, c, }\KeywordTok{d}\NormalTok{(a))))}
\end{Highlighting}
\end{Shaded}

...
Another way to see what's going on is to use `pryr::unenclose()`, which substitutes the variables defined in the enclosing environment into the original function:
...
Closures are useful for making function factories, and are also one way to manage mutable states in R. 

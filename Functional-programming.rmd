...
If we want to call each of the functions to check that we've implemented them correctly and that they return the same answer, we can use `lapply()`, either as an anonymous function or an named function.

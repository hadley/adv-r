...
The power of closures is tightly coupled to [[functionals]] and [[function operators]], and you'll see many more examples of closures in those two chapters.  The following section discusses the remaining important property of functions: the ability to store them in a list.

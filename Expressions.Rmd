...
<!-- GVW: "compute _on_ the language" sounds odd to me -->
...
<!-- GVW: the word "quoted" suggests "converted to string" (at least it did to my younger self, who was very confused by the term).  Clarify this up front? -->
...
<!-- GVW: is GitHub-based installation still going to be necessary by the time this is out, or will packages be on CRAN? -->

## Abstract syntax trees
\index{abstract syntax tree}

<!-- GVW: first sentence below explains the "tree" part of "abstract syntax tree" but not "abstract syntax" (which will probably be less familiar to readers) -->
...
<!---- if "symbols" gets a full definition elsewhere, point to it here -------->
<!---- I get why they're later, it's just ~weird to have bold and no def ------>
...
<!-- GVW: anyone who isn't already familiar with quoting and unquoting is going to be pretty confused at this point -->
...
As discussed in Section \@ref(prefix-transform), any call can be converted to prefix form. That means that these two lines of code are equivalent:
...
### Function factories
<!----- if call isn't defined earlier, do so here -------------->
...
<!-- GVW: a table here would be very helpful -->

### Constants
\index{constants}

<!-- GVW: "occur", not "occurred" -->
...
<!-- GVW: by "scalar", do you mean "vector of length 1"? -->
...
<!-- GVW: in _the_ AST.  Also, can we refer to these as "call objects" rather than "calls"? The latter is confusing me... -->
...
<!-- GVW: maybe "The first argument should identify the function to be called" - again, trying to distinguish this from a mode in which a defined function is passed as a first-class object -->
...
<!-- GVW: in the below, do you mean objects-that-represent-calls or actual-calls-on-the-stack-at-runtime? -->

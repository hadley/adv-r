...
The biggest different is the use of "expression". We use expression to . In base R, "expression" is a special type that is basically equivalent to a list of what we call expressions. To avoid confusion we'll call these __expression objects__, and we'll discuss them in [expression objects]. 

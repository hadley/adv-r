...
To conclude the chapter I'm going to use everything you've learned about ASTs to solve more complicated problems. The inspiration comes from the base [codetools package](https://cran.r-project.org/web/packages/codetools)[^codetools], which provides two interesting functions:

[^codetools]: Code Analysis Tools for R, Luke Tierney

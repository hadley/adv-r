...
This gives it rather peculiar behaviour since you can still access it in if it's stored in another data structure:
...
You can see if it's missing by using `is_missing()`:

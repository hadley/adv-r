...
The final section of the book collects chapters on programming techniques, including debugging, profiling, improving performance, and connecting R and C++. The contents chapters are very similar to the first edition, although the structure is a little different. I have made light updates, but the majority of the text is the same. The only major changes are to tools: I have replaced the microbenchmark package with bench, and lineprof with profvis.

...
Each of these attributes has a specific accessor function to get its values. When working with these attributes, use `names(x)`, `class(x)` and `dim(x)`, not `attr(x, "names")`, `attr(x, "class")`, and `attr(x, "dim")`.

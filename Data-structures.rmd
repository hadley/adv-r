...
Almost all other objects are built upon these foundations. In [the OO field guide](#oo-field-guide) you'll see how more complicated objects are built of these simple pieces. Note that R has 0-dimensional, or scalar types. Individual numbers or strings, which you might think would be scalars, are actually vectors of length one. 
...
* [Vectors](#vectors) introduces you atomic vectors and list, R's 1d 
  data structures.
  
* [Attributes](#attribute) takes a small detour to discuss attributes,
...
* [Matrices and arrays](#matrices-and-arrays) introdues matrices and arrays,
...
1.  The three properties of a vector are type, length, type and attributes.
...
1.  You can make "list-array" by assuming dimensions to a list. You can
    make can a matrix a column of a data frame with `df$x <- matrix()`, or

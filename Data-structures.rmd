...
Not all elements of a vector need to have names. If some names are missing, `names()` will return an empty string for those elements; if all names are missing `names()` will return NULL.

...
An atomic vector can only be of one type, so when you attempt to combine different types they will be __coerced__ to the lowest common type: (ordered from low to high) logical, integer, double and character.

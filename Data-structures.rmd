...
Lists are used to build up most of the more complicated data structures in R: both data frames (described below), and linear models (as produced by `lm()`) are lists:

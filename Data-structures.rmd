...
Lists are used to build up many of the more complicated data structures in R: for example, both data frames (described below), and linear models (as produced by `lm()`) are lists:
